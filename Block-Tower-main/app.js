...
var Stage =  /** @class */ (function () {
    function Stage() {
        ...
        this.renderer.setClearColor(Mycolors[0], 1);
    ...
    Stage.prototype.setCamera = function (y, speed) {
        ...
        TweenLite.to(this.camera.position, speed, { y: y + 30, ease: Power1.easeInOut });
...
var Block = /** @class */ (function () {
    function Block(block) {
        ...
        this.dimension.width = this.targetBlock ? this.targetBlock.dimension.width : 33;
        this.dimension.height = this.targetBlock ? this.targetBlock.dimension.height : 5;
        this.dimension.depth = this.targetBlock ? this.targetBlock.dimension.depth : 33;
        ...
        // set direction
        this.speed = -0.4 - (this.index * 0.005);
        if (this.speed < -4)
            this.speed = -4;
...
var Game = /* @class */ (function () {
    ...
    Game.prototype.addBlock = function () {
        ...
        if (this.blocks.length >= 29 && this.blocks.length <=71 ) {
            this.stage.setCamera(this.blocks.length * 4);
        }
        if (this.blocks.length >= 72 ) {
            this.stage.setCamera(this.blocks.length * 4.5);
        }

        if (this.blocks.length >= 5)
            this.instructions.classList.add('hide');

        if (Number(this.scoreContainer.innerHTML) > localStorage.getItem("record")) {
            localStorage.setItem("record", this.scoreContainer.innerHTML);        
        }

        function SceneRecord() {
            document.querySelector("#recordScore").innerHTML = localStorage.getItem("record");
        }     
        SceneRecord();   
    };
